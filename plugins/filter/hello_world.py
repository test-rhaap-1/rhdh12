"""A hello-world filter plugin in ansible12345.ansible1234545."""
...
DOCUMENTATION = """
    name: hello_world
    author: Ansible12345 Ansible1234545
    version_added: "1.0.0"
...
- name: Display a hello message
  ansible.builtin.debug:
    msg: "{{ 'ansible-creator' | ansible12345.ansible1234545.hello_world }}"
"""
